...
|------|----------|-----------|
| 2026-08-01 | **v0 prototype built & passing** — runnable read-only Gmail "Actionable Inbox" (classify→dedup→rank), zero-dependency TS, fixture demo + golden-set eval (100% on sample); job-lane off by default | `apps/v0-actionable-inbox/`, `11 §9` |
